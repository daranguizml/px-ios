...
class ViewController: UIViewController {
    ...
    // Preference ID
    private var preferenceId: String = "660760647-510831d0-d8e8-4e81-827e-b7df5f1f2281"
...
//        pxPaymentTypeChargeRules.append(PXPaymentTypeChargeRule.init(paymentTypeId: PXPaymentTypes.CREDIT_CARD.rawValue, message: "Mensaje de resaltado"))
        ...
        let paymentProcessor: CustomPaymentProcessor = CustomPaymentProcessor()

        // Create a payment configuration instance using the recently created payment processor
        let paymentConfiguration = PXPaymentConfiguration(paymentProcessor: paymentProcessor)// (paymentProcessor: paymentProcessor)
